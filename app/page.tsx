...
import {Music, Trophy, Mic2, Palette, Film, Utensils} from "lucide-react";
...
const categories = [
  ...
  {name: "Comedy", icon: Mic2, color: "text-yellow-500"},
  {name: "Art", icon: Palette, color: "text-teal-500"},
  {name: "Film", icon: Film, color: "text-blue-500"},
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <div className="relative p-10 md:p-14 rounded-3xl bg-card border border-border shadow-2xl pt-14">
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-14 h-14 bg-primary rounded-full flex items-center justify-center shadow-lg text-primary-foreground">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M14.017 18L14.017 10.609C14.017 4.905 17.748 1.039 23 0L23.995 2.151C21.563 3.068 20 5.789 20 8H24V18H14.017ZM0 18V10.609C0 4.905 3.748 1.038 9 0L9.996 2.151C7.563 3.068 6 5.789 6 8H9.983L9.983 18L0 18Z" /></svg>
              </div>
        ...
        <section className="relative overflow-hidden bg-primary py-24 text-primary-foreground">
          <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: "radial-gradient(circle at center, rgba(255,255,255,0.15) 0, transparent 60%)" }} />
          <div className="relative container mx-auto px-4 text-center">
            ...
            <p className="mx-auto mb-10 max-w-xl text-lg text-primary-foreground/90 font-medium">
              Join thousands of event-goers who have discovered unforgettable experiences across Sri Lanka through
              BookMySeat.
            </p>
            <Link
              href="/register"
